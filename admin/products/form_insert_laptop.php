...
include '../menu.php';
require '../connect.php';
$sql = "SELECT cau_hinh_chi_tiet.ma, cau_hinh.ten, cau_hinh_chi_tiet.gia_tri
...
<div>
    <h1> Thêm laptop </h1>
    <form class="form" id="create_laptop" method="post" action="./process/insert_laptop.php">
        Tên laptop
        <input type="text" name="ten_laptop" id="ten_laptop">
        <span id="loi_ten" class="loi"></span>
        <br>
        <br>
        Giá
        <input type="number" name="gia" id="gia_laptop">
        ...
        <br>
        <button type="submit" class="btn" value="Thêm" onclick="return validate()">Thêm</button>
    </form>
</div>
